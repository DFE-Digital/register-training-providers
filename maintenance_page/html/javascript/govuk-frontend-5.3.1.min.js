  ...
  for (const [n, i] of Object.entries(e.schema.properties))
    (n in t && (s[n] = normaliseString(t[n], i)),
      "object" === (null == i ? void 0 : i.type) &&
        (s[n] = extractConfigByNamespace(e, t, n)));
  return s;
}
...
class I18n {
  constructor(e = {}, t = {}) {
    ...
    ((this.translations = void 0),
      ...
      (this.translations = e),
      (this.locale =
        null != (s = t.locale) ? s : document.documentElement.lang || "en"));
  }
  t(e, t) {
  ...
  constructor(t, s = {}) {
    ...
    ((this.$module = t),
      (this.config = mergeConfigs(
        Accordion.defaults,
        s,
        normaliseDataset(Accordion, t.dataset),
      )),
...
class Tabs extends GOVUKFrontendComponent {
  ...
  activateNextTab() {
    ...
    s &&
      (this.hideTab(e), this.showTab(s), s.focus(), this.createHistoryEntry(s));
  }
  activatePreviousTab() {
    const e = this.getCurrentTab();
    if (null == e || !e.parentElement) return;
