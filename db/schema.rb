...
ActiveRecord::Schema[8.1].define(version: 2026_08_21_134746) do
  ...
  create_table "academic_years", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["duration"], name: "index_academic_years_on_duration"
  end
  ...
  create_table "api_clients", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["created_by_id", "name"], name: "index_api_clients_on_created_by_and_name", unique: true, where: "(discarded_at IS NULL)"
  ...
  create_table "partnership_academic_years", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["academic_year_id"], name: "index_partnership_academic_years_on_academic_year_id"
    t.index ["partnership_id"], name: "index_partnership_academic_years_on_partnership_id"
  end
  ...
  create_table "provider_academic_years", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "academic_year_id", null: false
    t.datetime "created_at", null: false
    t.datetime "discarded_at"
    t.uuid "provider_id", null: false
  ...
  create_table "provider_changes", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["provider_id", "attribute_name", "effective_on"], name: "idx_on_provider_id_attribute_name_effective_on_d4e00b3792"
  end
  ...
  add_foreign_key "partnership_academic_years", "partnerships"
  ...
  add_foreign_key "provider_changes", "providers"
  add_foreign_key "provider_changes", "users", column: "created_by_id"
