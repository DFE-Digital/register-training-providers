...
**Generated:** 2026-09-14T12:14:21Z
...
| `new_operating_name` | New Operating Name | `ProviderChanges::Steps::OperatingNameStep`    |
...
**Entry Point:** ✓ Yes
**Exit Points:** `new_operating_name`
...
### Step: `new_operating_name`

**Label:** New Operating Name
**Class:** `ProviderChanges::Steps::OperatingNameStep`
**Entry Point:** ✗ No
...
| Attribute        | Type                       | Required | Description |
| ---------------- | -------------------------- | :------: | ----------- |
| `operating_name` | `ActiveModel::Type::Value` |    ✗     |             |

#### Validations

- **operating_name** (`presence`):
...
| From                 | To                   | Behavior                       |
| -------------------- | -------------------- | ------------------------------ |
| `effective_date`     | `new_operating_name` | Always proceeds (no condition) |
| `new_operating_name` | `check_your_answers` | Always proceeds (no condition) |
...
```json
{
  ...
  :transitions: [
    {
      :from: "effective_date",
      :to: "new_operating_name",
      :type: "simple",
      :label: null
    },
    {
      :from: "new_operating_name",
  ...
  :wizard_name: "Provider changes/operating name wizard"
}
```
