RSpec.feature "Editing provider code" do
  ...
  scenario "User can edit a provider code" do
    ...
    and_i_review_the_check_your_answers_step
  ...
  def and_i_review_the_check_your_answers_step
    expect(page).to have_link("Back", href: "/providers/#{provider_with_code_to_change.id}/changes/code/provider_code")
    ...
    and_the_check_your_answers_step_details_are_correct
    and_i_click_on("Confirm and continue")
  end

  def and_the_check_your_answers_step_details_are_correct
    within("dl.govuk-summary-list") do
      ...
      within(".govuk-summary-list__row", text: "New provider code") do
        ...
        expect(page).to have_link(
          ...
          href: "/providers/#{provider_with_code_to_change.id}/changes/code/provider_code?return_to_review=provider_code"
        )
      end
      ...
      within(".govuk-summary-list__row", text: "Effective on") do
        ...
        expect(page).to have_link(
          "Change effective on",
          href: "/providers/#{provider_with_code_to_change.id}/changes/code?return_to_review=effective_academic_year"
        )
      end
    end

    click_on "Change new provider code"
    and_i_am_taken_to("/providers/#{provider_with_code_to_change.id}/changes/code/provider_code?return_to_review=provider_code")

    click_on "Continue"
    and_i_am_taken_to("/providers/#{provider_with_code_to_change.id}/changes/code/check_your_answers")

    click_on "Change effective on"
    and_i_am_taken_to("/providers/#{provider_with_code_to_change.id}/changes/code?return_to_review=effective_academic_year")
    click_on "Continue"
    and_i_am_taken_to("/providers/#{provider_with_code_to_change.id}/changes/code/check_your_answers")
  end

  def and_i_fill_in_the_code_step
    expect(page).to have_link("Back", href: "/providers/#{provider_with_code_to_change.id}/changes/code")
    ...
    and_i_fill_in_the_code_step_incorrectly_with_another_existing_provider_code
  ...
  def and_i_fill_in_the_code_step_incorrectly_with_another_existing_provider_code
  ...
  def and_i_fill_in_the_effective_academic_year_step
    ...
    and_i_am_taken_to("/providers/#{provider_with_code_to_change.id}/changes/code/provider_code")
  end
  ...
  def when_i_navigate_to_the_provider_page_to_change_code
    ...
    and_i_am_taken_to("/providers/#{provider_with_code_to_change.id}/changes/code")
  end
