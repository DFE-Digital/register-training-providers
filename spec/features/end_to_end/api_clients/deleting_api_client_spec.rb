...
RSpec.feature "api client management" do
  scenario "deleting Api Clients" do
    ...
    and_i_can_see_the_page_title_for_view_api client
    and_i_click_on("Delete api client")
    and_i_am_taken_to("/api_clients/#{api_client_to_delete.id}/delete")

    and_i_can_see_the_page_title_for_confirm_you_want_to_delete_api client
  ...
  def and_i_can_see_the_warning_text
    expect(page).to have_warning_text("Deleting a api client is permanent – you cannot undo it.")
  end
