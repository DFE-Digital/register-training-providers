DfE::Analytics.configure do |config|
  ...
  # Translation missing: en.dfe.analytics.config.ignore_default_scope_entities.default
  ...
  #
  # config.airbyte_internal_dataset = ENV['AIRBYTE_INTERNAL_DATASET']
  ...
  #
  # config.airbyte_configuration = ENV['AIRBYTE_CONFIGURATION']
end
