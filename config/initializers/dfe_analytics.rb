DfE::Analytics.configure do |config|
  # Translation missing: en.dfe.analytics.config.ignore_default_scope.description
  #
  # config.ignore_default_scope = Translation missing: en.dfe.analytics.config.ignore_default_scope.default

  # Translation missing: en.dfe.analytics.config.ignore_default_scope_entities.description
  #
  # config.ignore_default_scope_entities = Translation missing: en.dfe.analytics.config.ignore_default_scope_entities.default
  ...
  #
  # config.bigquery_airbyte_dataset = ENV['BIGQUERY_AIRBYTE_DATASET']
  ...
  # The name of the BigQuery hidden policy tag applied to PII in raw airbyte tables.
  #
  # config.bigquery_hidden_policy_tag = ENV['BIGQUERY_HIDDEN_POLICY_TAG']
  ...
  #
  # config.airbyte_stream_config_path = /terraform/aks/workspace-variables/airbyte_streams.json

  # Airbyte Client Id for retrieving access token
  #
  # config.airbyte_client_id = ENV['AIRBYTE_CLIENT_ID']

  # Airbyte Client secret for retrieving access token
  #
  # config.airbyte_client_secret = ENV['AIRBYTE_CLIENT_SECRET']

  # Airbyte server base URL
  #
  # config.airbyte_server_url = ENV['AIRBYTE_SERVER_URL']

  # Airbyte Workspace Id for this App contains source, destination and connection
  #
  # config.airbyte_workspace_id = ENV['AIRBYTE_WORKSPACE_ID']
end
